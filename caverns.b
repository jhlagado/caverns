...
9  GOTO 72
10  IF A=1 THEN  PRINT "You are standing in a darkened CLEAR  room. There is a door to the     north."
...
12  IF A=3 THEN  PRINT "You are deep in a dark forest. In the d ON istance you can see a    mighty river."
NaN
24964 =4 THEN  PRINT "You are standing in a field of four-leafed clovers. There is a  small hut to the north."
...
19  IF A=8 THEN  PRINT "The path 3to the east stops here. You are on a rocky outcrop,    projected about 15 feet above the river. In the distance,       a tinybridge spans the river."
20  IF A=9 THEN  PRINT "You are on the lower slopes of Mt. Ymir. The forest stretches   far away and to the west. Arc AUTO tic winds blow fiercely, it's very cold!"
21  IF A=10 THEN  PRINT "You stand on a rocky precipice high above the river, Gioll;     Mt. Ymir stands to the north. A flimsy string bridge spans the  mightyriver."
22  IF A=11 THEN  PRINT "You have made your way half way across the creaki SAVE ng bridge.     It sways violently from side to side. It's going to collapse anysecond!!"
23  IF A=12 THEN  PRINT "You are on the southern edge of the mighty river, before        the string bridge."
24  IF A=14 THEN  PRINT "You are in a clearing in the forest. An ancient basalt rock  .    formation towers above you. To your south is the entrance of a  VERYinteresting cave..."
25  IF A=16 THEN  PRINT "You are just inside the cave. Sunlight pours into the cave      lighting a path to the east and another to the south. I don't   mind saying I'm a bit s?cared!"
...
30  IF A=23 THEN  PRINT "You are standing i AND n what appears to have once been a torture    chamber. Apart from the rather comprehensive range of instumentsof absolutely inhuman agony,"
...
33  IF A=26 THEN  PRINT "You are in a large round room with a  RETURN number of exits. The walls have been painted in a mystical dark purple and a big chalk staris drawn in the centre of "
34  IF A=26 THEN  PRINT "the floor. Note: This is one of the hidden chambers of the      infamous pagan sect, the monks of Loki. Norse folk believe the]m to begods."
...
38  IF A=33 THEN  PRINT "You are in the central cave o EDASM f a giant bat colony. Above you    hundreds of giant bats hang from the ceiling and the floor iscovered in centuries of "
39  IF A=33 THEN  PRINT "giant bat droppings. Careful where you step! Incidentally, the  smell is indescribable."
40  IF A=35 THEN  PRINT "You are in the templ STOP e. To the north is a locked gate and on the wall is a giant statue of Loki, carved out of the living rock   itself!"
41  IF A=37 THEN  PRINT "You stand in an old and musty crypt, the final resting place of hundreds of Loki devotees. On the wall is carved:``What 3 letter2 wordcompletes a word "
...
45  IF A>40  AND  A<45 THEN  PRINT "Somehow you have gotten into t HIRES he complex drainage system of thisentire cavern network!!"
...
64512 J IF A=53 THEN  PRINT "You stand before a small wooden bridge which crosses the river."
53  IF A=52 THEN  PRINT "You are on the eastern side of the river. A small tunnel leads  east into the cliff face."
54  IF A=54 THEN  PRINT "You are in a conduit draining into the river. The water comes upto  RESTORE your knees and is freezing cold. A narrow service path leads south."
...
56  IF (A=10 OR A=12) AND H=128 THEN  PRINT "Two of the ropes have snapped under your weight. It's totally unfit to cros.s again."
...
142  PRINT "You open RND ed the door.":P(19)=A:R=0: IF A=2 THEN  LET A=1: GOTO 5 ELSE  LET A=37: GOTO 5
...
148  IF L=0 THEN  PRINT "You atta?ck but the creature moves aside."
...
185   DATA  " moon-like"," pearl ","n interesting"," stone "," diamond studded"," ring "," magic USED "," pendant "," most holy"," grail "," mirror like"," shield "
...
187
8340  grill "
10496 H  DATA  36,19,10,14,17,47,8,1,51,45,22,46,54,19,19,19,19,0,34,7,18,15,24,38
189   DATA  " north "," south "," west "," east "
190   DATA  " take "," put "," using "," with "," cut "," break "," unlock "," open "," kill "," attack "
191   DATA  " light "," burn "," up "," dow LIST n "," jump "," swim "
...
197  IF S=126 THEN  PRINT "Perfectioni FOR st and genius!!"
198  RETURN
...
201  GOTO 77
202  PRINT "Before the entrance of the cave lies an enormous, green,        sleeping dragon. Re PRINT alizing your presence, its eyes flicker open"
