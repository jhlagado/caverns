...
960  NEXT L
990  INPUT A0$: IF A0$="" THEN 990 ELSE  LET A0$=" "+A0$+" ":U=U+1:C0=C0-1: FOR X=2 TO  LEN (A0$)-1:Y= ASC (A0$(;X)): IF Y>64 AND Y<91 THEN  LET A1$=A0$(;1,X-1)+(Y+32)+A0$(;X+1):A0$=A1$
...
2480  RESTORE 2520: FOR K=1 TO L: READ H0$,H1"$:K:"a";H0$;H1$;", ";:
...
2610  IF S<100 AND S>49 THEN  PRINT "Average Viking" AND <> IF S<126 AND S>99 THEN  PRINT "Excellent...but you've left something behind!"
...
3002  DATA "pus",2300,"pre",2300,"dri",2440 ">0"Which dis ERROR k?":270
