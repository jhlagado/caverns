...
const play = (tone, length) => { }

const print = (text) => {
    console.log(text);
}

const printChar = (char, num) => {
    const s = Array(num).fill(char).join('');
    print(s);
}
...
// 188 DATA 36,19,10,14,17,47,8,1,51,45,22,46,54,19,19,19,19,0,34,7,18,15,24,38
const data188 = [36, 19, 10, 14, 17, 47, 8, 1, 51, 45, 22, 46, 54, 19, 19, 19, 19, 0, 34, 7, 18, 15, 24, 38]
...
const initState = {
    ...
    P: [...data188],
    R: 0,
    A: 1,   // current location
    C: 1,   // candle 0: not_lit, 1 = lit
    F: 0,
    U: 0,   // user
    Z: 0,
};

const drainageDesc = 'Somehow you have gotten into the complex drainage system of this entire cavern network!!';
const darkCavernDesc = 'You are deep in a dark cavern.';

const roomDesc = {
    1: 'You are standing in a darkened room. There is a door to the north.',
    2: 'You are in a forest clearing before a small bark hut. There are no windows, and locked door to the south. The latch was engaged when you closed the door.',
    3: 'You are deep in a dark forest. In the distance you can see a mighty river.',
    4: 'You are standing in a field of four-leafed clovers. There is a small hut to the north.',
    5: 'The forest has opened up at this point. You are standing on a cliff overlooking a wide glacial river. A small foot-beaten path leads south.',
    6: 'You are standing at the rocky edge of the mighty river Gioll. The path forks east and west.',
    7: 'You are on the edge of an enormous crater. The rim is extremely slippery. Clouds of water vapour rise high in the air as the Gioll pours into it.',
    8: 'The path to the east stops here. You are on a rocky outcrop, projected about 15 feet above the river. In the distance, a tiny bridge spans the river.',
    9: 'You are on the lower slopes of Mt. Ymir. The forest stretches far away and to the west. Arctic winds blow fiercely, it\'s very cold!',
    10: 'You stand on a rocky precipice high above the river, Gioll; Mt. Ymir stands to the north. A flimsy string bridge spans the mighty river.',
    11: 'You have made your way half way across the creaking bridge. It sways violently from side to side. It\'s going to collapse any second!!',
    12: 'You are on the southern edge of the mighty river, before the string bridge.',
    13: 'You are standing on a rock in the middle of a mighty oak forest. Surrounding you are thousands of poisonous mushrooms.',
    14: 'You are in a clearing in the forest. An ancient basalt rock formation towers above you. To your south is the entrance of a interesting cave...',
    15: 'You are on a cliff face over looking the river.',
    16: 'You are just inside the cave. Sunlight pours into the cave lighting a path to the east and another to the south. I don\'t mind saying I\'m a bit scared!',
    17: 'This passage appears to be a dead end. On a wall before you is carved \'Find the Sacred Key of Thialfi\'.',
    18: darkCavernDesc,
    19: 'You are in the legendary treasure room of the black elves of Svartalfheim. Every red-blooded Viking has dreamed of entering this sacred room.',
    20: 'You can see a small oak door to the east. It has been locked from the inside.',
    21: darkCavernDesc,
    22: 'You are standing in an east-west corridor. You can feel a faint breeze coming from the east.',
    23: 'You are standing in what appears to have once been a torture chamber. Apart from the rather comprehensive range of instuments of absolutely inhuman agony, coagulated blood stains on the walls and mangled bits of bone on the floor make me think that a number of would be adventurers croaked it here!',
    24: 'You stand in a long tunnel which has been bored out of the rock. It runs from north to south. A faint glow comes from a narrow crack in the eastern wall.',
    25: darkCavernDesc,
    26: 'You are in a large round room with a number of exits. The walls have been painted in a mystical dark purple and a big chalk star is drawn in the centre of the floor. Note: This is one of the hidden chambers of the infamous pagan sect, the monks of Loki. Norse folk believe them to be gods.',
    27: 'You are standing on a narrow ledge, high above a subterranean river. There is an exit to the east. ',
    28: 'You are on a balcony, overlooking a huge cavern which has been converted into a pagan temple. Note: this temple has been dedicated to Loki, the god of fire, who came to live in Svartalfheim after he had been banished to exile by Odin. Since then he has been waiting for the `End Of All Things\'.',
    29: darkCavernDesc,
    30: darkCavernDesc,
    31: darkCavernDesc,
    32: darkCavernDesc,
    33: 'You are in the central cave of a giant bat colony. Above you hundreds of giant bats hang from the ceiling and the floor is covered in centuries of giant bat droppings. Careful where you step! Incidentally, the smell is indescribable.',
    34: darkCavernDesc,
    35: 'You are in the temple. To the north is a locked gate and on the wall is a giant statue of Loki, carved out of the living rock itself!',
    36: darkCavernDesc,
    37: 'You stand in an old and musty crypt, the final resting place of hundreds of Loki devotees. On the wall is carved:``What 3 letter word completes a word starting with \'G---\' and another ending with \'---X\' Note: The monks of Loki must have liked silly puzzles. Putrefaction and decay fills the air here.',
    38: 'You are in a tiny cell. The western wall has now firmly closed again. There is a ventilator shaft on the eastern wall.',
    39: darkCavernDesc,
    40: 'You are on another ledge high above a subterranean river. The water flows in through a hole in the cavern roof, to the north.',
    41: drainageDesc,
    42: drainageDesc,
    43: drainageDesc,
    44: drainageDesc,
    45: 'You are standing near an enormous waterfall which brings water down from the surface, from the river Gioll.',
    46: darkCavernDesc,
    47: 'You are standing before a stone staircase which leads southwards.',
    48: 'You are on a narrow and crumbling ledge. On the other side of the river you can see a magic castle. (Don\'t ask me why it\'s magic...I just know it is)',
    49: 'You are by the drawbridge which has just lowered itself....by magic!!',
    50: 'You are in the courtyard of the magic castle. WOW! This castle is really something! On the wall is inscribed \'hzb tzozi\'. A secret escape tunnel leads south',
    51: 'You are in the powder magazine of this really super castle.',
    52: 'You are on the eastern side of the river. A small tunnel leads east into the cliff face.',
    53: 'You stand before a small wooden bridge which crosses the river.',
    54: 'You are in a conduit draining into the river. The water comes up to your knees and is freezing cold. A narrow service path leads south.',
};

const printRoomDesc = (state) => {
    ...
    // 16 IF A=5 THEN PRINT "The forest has opened up at this point. You are standing on a cliff overlooking a wide glacial river. A small foot-beaten path leads south."
    ...
    // 19 IF A=8 THEN PRINT "The path to the east stops here. You are on a rocky outcrop, projected about 15 feet above the river. In the distance, a tiny bridge spans the river."
    ...
    // 22 IF A=11 THEN PRINT "You have made your way half way across the creaking bridge. It sways violently from side to side. It's going to collapse any second!!"
    // 23 IF A=12 THEN PRINT "You are on the southern edge of the mighty river, before the string bridge."
    // 24 IF A=14 THEN PRINT "You are in a clearing in the forest. An ancient basalt rock formation towers above you. To your south is the entrance of a interesting cave..."
    ...
    // 27 IF A=19 THEN PRINT "You are in the legendary treasure room of the black elves of Svartalfheim. Every red-blooded Viking has dreamed of entering this sacred room."
    ...
    // 30 IF A=23 THEN PRINT "You are standing in what appears to have once been a torture chamber. Apart from the rather comprehensive range of instuments of absolutely inhuman agony,"
    // 31 IF A=23 THEN PRINT "coagulated blood stains on the walls and mangled bits of bone on the floor make me think that a number of would be adventurers croaked it here!"
    ...
    // 33 IF A=26 THEN PRINT "You are in a large round room with a number of exits. The walls have been painted in a mystical dark purple and a big chalk star is drawn in the centre of "
    // 34 IF A=26 THEN PRINT "the floor. Note: This is one of the hidden chambers of the infamous pagan sect, the monks of Loki. Norse folk believe them to be gods."
    // 35 IF A=27 THEN PRINT "You are standing on a narrow ledge, high above a subterranean river. There is an exit to the east. "
    // 36 IF A=28 THEN PRINT "You are on a balcony, overlooking a huge cavern which has been converted into a pagan temple. Note: this temple has been dedicated to Loki, the god of"
    ...
    // 41 IF A=37 THEN PRINT "You stand in an old and musty crypt, the final resting place of hundreds of Loki devotees. On the wall is carved:``What 3 letter word completes a word "
    ...
    // 43 IF A=38 THEN PRINT "You are in a tiny cell. The western wall has now firmly closed again. There is a ventilator shaft on the eastern wall."
    ...
    // 45 IF A>40 AND A<45 THEN PRINT "Somehow you have gotten into the complex drainage system of this entire cavern network!!"
    ...
    // 49 IF A=49 THEN PRINT "You are by the drawbridge which has just lowered itself....by magic!!"
    ...
    // 51 IF A=51 THEN PRINT "You are in the powder magazine of this really super castle."
    // 52 IF A=52 THEN PRINT "You are on the eastern side of the river. A small tunnel leads east into the cliff face."
    // 53 IF A=53 THEN PRINT "You stand before a small wooden bridge which crosses the river."
    // 54 IF A=54 THEN PRINT "You are in a conduit draining into the river. The water comes up to your knees and is freezing cold. A narrow service path leads south."
    ...
    if (A < 18 || (C0 == 1 && P[21] == A || P[21] == -1)) {
        ...
        let v = 0;
        for (let l = 7; l <= 24; l++) {
            if (state.p[l] == state.A) v++;
        }
        if (v > 0) {
            print(`\nYou can also see...\n`);
            for (let l = 7; l <= 24; l++) {
                if (state.p[l] == state.A) gosub165(l);
            }
        }
    }
    else {
...
function caverns() {
    ...
    // 1 POKE 162,30: POKE 163,128: RESTORE 208: FOR X=0 TO 41: READ Y: POKE 62976+X,Y: NEXT X: ON ERROR GOTO 209
    ...
    setSpeed(255)
    setCursor(1, 4);
    print(' DREAMCARDS presents... ');
    setSpeed(0)
    setCursor(20, 6);
    print(`C A V E R N S by John Hardy (1983)`);
    setCursor(0, 0);
    play(0, 40);
    clearScreen();
    setCursor(1, 7);
    ...
    // 80 FOR X=1 TO LEN (A0$):Y= ASC (A0$(;X)): IF Y>64 AND Y<91 THEN LET A1$=A0$(;1,X-1)+ CHR (Y+32)+A0$(;X+1):A0$=A1$
    // 81 NEXT X: CLS
    A0$ = A0$.toLowercase();
    clearScreen();
    ...
    const t = data184.find(([N0$, N1$]) => A0$.includes(N1$));
    const [N0$, N1$] = t ? t : ['', ''];
    ...
    if (state.A == 11) state.H = 128
    if (state.A == 2) state.J = 1
    if (state.A == 45) state.W = 43
    if (state.A == 35) state.W = 0
    //REM IF P(Z24)<>38 THEN LET G=39
    if (state.A == 49) state.D = 49
    ...
    state.S = 0;
    for (let l = 7; l <= 24; l++) {
        if (state.P(x) == -1) s += (x - 6);
        if (state.P(x) == 1) s += (x - 6) * 2;
    }
    ...
    // 125 R=0: PRINT "Suddenly a magic wind carried you to another place...":A=16: GOTO 5
    ...
    // 153 PRINT "The sword strikes home and your foe dies...":P(M1)=-1: IF Z=3 OR Z=5 THEN LET P(Z)=P(Z)+10 ELSE LET P(Z)=0: IF Z=1 THEN PRINT "Hey! Your swordhas just crumbled into dust!!":P(20)=35
    ...
    // 163 IF A=28 THEN 164 ELSE PRINT "It's too dangerous!! FLT !": GOTO 5
    ...
    // 179 DATA 45,48,36,128,46,43,54,42,46,43,41,43,46,38,42,44,47,47,0,47,0,40,0,128
    ...
    // 204 GOTO 77
    // 205 PRINT "From around the corner trots an old and gnarled drawf carrying a lantern. `My job is to protect these stone steps!' he says and lunges at you with his dagger."
    // 206 GOTO 77
